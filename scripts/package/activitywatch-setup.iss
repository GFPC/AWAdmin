...
#define MyAppName "gfp_activitywatch_admin"
#define MyAppVersion GetEnv('AW_VERSION')
#define MyAppPublisher "GFP Contributors"
...
AppId={{28613330-B8C9-42AF-A913-C7F2F4FC2E21}
AppName={#MyAppName}
...
OutputDir={#DistDir}
OutputBaseFilename=gfp_activitywatch_admin-setup
...
[Files]
Source: "{#DistDir}\gfp_activitywatch_admin\aw-qt.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DistDir}\gfp_activitywatch_admin\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
